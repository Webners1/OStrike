...
export enum Vaults {
  ...
  CrabVault = 'Crab BCH', // long 2 eth + short squeeth
  // ETHZenBull = 'Zen Bull BCH', // long 3 eth + short squeeth
  Custom = 'Custom Strategy', // long x eth + short squeeth
  Short = 'Short Strike', //pure short squeeth
}

export enum VaultSubtitle {
  ETHBear = 'Coming Soon',
  CrabVault = 'Stack BCH',
  // ETHZenBull = 'Stack BCH',
}
...
export enum Tooltips {
  ImplVol = 'Implied Volatility (IV) is a market forecast of BCH price movement implied by squeeth',
  UnrealizedPnL = 'Total profit / loss if you were to fully close your position at the current SBCH price on Uniswap. Resets if you close your position or change position sides (long to short, or vice versa)',
  ...
  PnLExplanation = 'Strike performance is affected by implied volatility, premiums, BCH price, and price impact.',
  ShortCollateral = 'Takes BCH collateral into account.',
  Mark = 'The price squeeth is trading at. Because squeeth has convexity, Mark should be greater than BCH^2',
  ...
  SBCHPrice = 'Price of SBCH on Uniswap',
  ...
  SellCloseAmount = 'Amount of SBCH to buy',
  CurrentCollRatio = 'Collateral ratio for current short position',
  SellOpenAmount = 'Minimum collateral amount is 6.9 BCH to ensure system solvency with sufficient liquidation incentive',
  LiquidationPrice = 'Price of BCH when liquidation occurs.',
  ...
  VaultLiquidations = 'The strategy is subject to liquidations if it goes below 150% collateral, but rebalancing based on large BCH price changes helps prevent a liquidation from occurring.',
  ...
  StrategyLiquidations = 'The strategy is subject to liquidations if it goes below 150% collateral, but rebalancing based on large BCH price changes helps prevent a liquidation from occurring.',
  StrategyShort = 'The amount of SBCH the whole strategy is short',
  ...
  StrategyProfitThreshold = 'Based on current premiums, crab strategy would be unprofitable if BCH moves more than approximately the profit threshold in either direction before the next hedge. This profitable price range is based on the current premium and will change continuously as the premium changes',
  BullStrategyProfitThreshold = 'Based on current premiums, zen bull strategy would be unprofitable if BCH moves more than approximately the profit threshold in either direction before the next hedge. This profitable price range is based on the current premium and will change continuously as the premium changes',
  ...
  SBCHRefVol = 'Strike reference volatility based on deribit options and squeeth replicating portfolio. Strike ref vol is calculated/refreshed every 5 minutes.',
  ETHUp2x = 'The value of your position if BCH goes up 2x, not including premiums',
  ETHDown50 = 'The value of your position if BCH goes down 50%, not including premiums',
...
export enum Links {
  ...
  UniswapSwap = 'https://app.uniswap.org/#/swap?inputCurrency=BCH&outputCurrency=0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B',
...
export const UniswapIFrameOpen = {
  1: `https://app.uniswap.org/#/add/BCH/${OSQUEETH[1]}/3000`,
  3: `https://squeeth-uniswap.netlify.app/#/add/BCH/${OSQUEETH[3]}/3000`,
  5: `https://squeeth-uniswap.netlify.app/#/add/BCH/${OSQUEETH[5]}/3000`,
  31337: 'https://app.uniswap.org/#/add/BCH/0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B/3000', // Should be replaced with arbitrum subgraph
  421611: 'https://app.uniswap.org/#/add/BCH/0xf1B99e3E573A1a9C5E6B2Ce818b617F0E664E86B/3000', // Should be replaced with arbitrum subgraph
}
